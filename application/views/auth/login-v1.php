		...
		<?= $this->session->flashdata('message'); ?>
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section" style="color: black;font-family: Poppins;">Login - Laundry CandyCrush
					</h2>
				...
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex" style="border-radius: 15px;">
						...
						<div class="login-wrap p-4 p-md-5">
							...
							<form action="<?= base_url('auth') ?>" class="signin-form" style="font-family: Poppins;" method="POST">
								<div class="form-group mb-3">
									<label class="label" for="name">Username</label>
									<input type="text" name="username" class="form-control" placeholder="<?= form_error('username');?>" required>
								</div>
							...
							<p class="text-center">Belum Punya Akun? <a href="<?=base_url('auth/register')?>">Daftar</a></p>
						</div>
					</div>
				</div>
			</div>
